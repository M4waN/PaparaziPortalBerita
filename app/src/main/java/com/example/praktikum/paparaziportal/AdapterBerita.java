...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tvTglTerbit.setText(berita.get(position).getCreatedAt());

        // Dapatkan url gambar
        final String urlGambarBerita = "http://apptesterarmawan.000webhostapp.com/assets/img/" + berita.get(position).getGambarBerita();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                varIntent.putExtra("TGL_BERITA", berita.get(position).getCreatedAt());
                varIntent.putExtra("PNS_BERITA", berita.get(position).getIdPenulis());
                varIntent.putExtra("FTO_BERITA", urlGambarBerita);
                varIntent.putExtra("ISI_BERITA", berita.get(position).getIsiBerita());
                varIntent.putExtra("SLG_BERITA", berita.get(position).getSlugBerita());
